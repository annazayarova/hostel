                ...
                <g id="Web_1920_1" data-name="Web 1920 – 1" clip-path="url(#clip-Web_1920_1)">
                    <g id="Group_2" data-name="Group 2">
                        <g id="Group_1" data-name="Group 1" transform="translate(0 -207)">
                            ...
                            <CatBottom id="_06-2" data-name="06" transform="translate(1524.16 198.576)">
...
const CatBottom = styled.g`
    animation: ${ opacityLong } 3s linear infinite 0.75s;
    visibility: hidden;

`;

const PotCat = styled.g`
    animation: ${ opacity } 3s linear infinite 1.5s;
    visibility: hidden;
